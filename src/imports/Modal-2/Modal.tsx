import svgPaths from "./svg-1alip9ontf";
...
function Tag() {
  return (
    <div className="bg-[#036ef2] content-stretch flex h-[40px] items-center justify-center px-[16px] py-[10px] relative rounded-[999px] shrink-0" data-name="Tag">
      <p className="font-['Bronkoh-Bold:Regular',sans-serif] leading-[1.3] not-italic relative shrink-0 text-[20px] text-white tracking-[-0.5px] whitespace-nowrap">Nível 4</p>
    </div>
  );
}
...
function Container() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0" data-name="Container">
      <Tag />
      <p className="font-['Bronkoh-Heavy:Regular',sans-serif] leading-[1.3] not-italic relative shrink-0 text-[40px] text-white tracking-[-0.5px] whitespace-nowrap">Estruturado</p>
    </div>
  );
}
