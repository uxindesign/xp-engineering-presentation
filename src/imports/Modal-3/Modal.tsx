import svgPaths from "./svg-95w42zbj97";
...
function Tag() {
  return (
    <div className="bg-[#036ef2] content-stretch flex h-[40px] items-center justify-center px-[16px] py-[10px] relative rounded-[999px] shrink-0" data-name="Tag">
      <p className="font-['Bronkoh-Bold:Regular',sans-serif] leading-[1.3] not-italic relative shrink-0 text-[20px] text-white tracking-[-0.5px] whitespace-nowrap">Nível 5</p>
    </div>
  );
}
...
function Container() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0" data-name="Container">
      <Tag />
      <p className="font-['Bronkoh-Heavy:Regular',sans-serif] leading-[1.3] not-italic relative shrink-0 text-[40px] text-white tracking-[-0.5px] whitespace-nowrap">Integrado</p>
    </div>
  );
}
...
function Content() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full" data-name="Content">
      <Container />
      <p className="font-['Bronkoh-lightItalic:Italic',sans-serif] italic leading-[1.2] min-w-full relative shrink-0 text-[30px] text-white w-[min-content]">{`"A UX está enraizada na cultura e no fluxo de trabalho. O design é contínuo e gera resultados consistentes."`}</p>
      <p className="font-['Manrope:Regular',sans-serif] font-normal leading-[1.4] min-w-full relative shrink-0 text-[20px] text-[rgba(255,255,255,0.6)] tracking-[0.25px] w-[min-content]">Quando as organizações atingem o estágio de UX integrado, o seu trabalho de UX torna-se abrangente, omnipresente e universal. Quase todas as equipas dentro da organização realizam atividades relacionadas com UX de forma eficiente e eficaz. Muitas vezes há inovação nos métodos e processos de UX e até contribuições para o campo do UX.</p>
    </div>
  );
}
